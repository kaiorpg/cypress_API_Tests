...
describe('Buscar dispositivos', ()=> {
    ...
    it('Buscar um dispositivo específico', () => {
        ...
        cy.buscarDeviceEspecifico(device_id)
            .then((response) => {
                ...
                expect(response.body.name).equal('Apple MacBook Pro 16').and.be.a('string')
                ...
                expect(response.body.data['CPU model']).equal('Intel Core i9').and.be.a('string')
    ...
    cy.log('Starting API response', response);
    }); 
})